...
export function accountBadges(entry = {}) {
    ...
    if (profile === 'supremo') {
        badges.push('<span class="account-insignia supreme-insignia" title="Desenvolvedor" aria-label="Desenvolvedor">♛ DEV</span>');
    } else if (profile === 'admin') {
        badges.push('<span class="account-insignia admin-insignia" title="Administrador · Oficial de Instrução" aria-label="Administrador">◆ ADM</span>');
    } else if (vip) {
