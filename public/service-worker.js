const CACHE_NAME = 'questionario-bizu-v4.51.2';
const APP_SHELL = [
    '/',
    '/index.html',
    '/manifest.webmanifest?v=4.51.2',
    '/assets/icons/icon-192-v448.png',
    '/assets/icons/icon-512-v448.png',
    '/assets/icons/icon-maskable-512-v448.png',
    '/assets/logo-questionario-bizu.svg?v=4.51.2',
    '/assets/icons/questionario-bizu-icon.svg?v=4.51.2',
