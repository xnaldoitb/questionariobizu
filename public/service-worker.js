const CACHE_NAME = 'questionario-bizu-v4.45.1-recompensas-progressivas';
...
const APP_SHELL = [
    ...
    '/assets/icons/icon-192-v435.png',
    '/assets/icons/icon-512-v435.png',
    '/assets/icons/icon-maskable-512-v435.png',
    '/assets/logo-questionario-bizu.svg?v=4.35.0',
    '/assets/icons/questionario-bizu-icon.svg?v=4.35.0',
