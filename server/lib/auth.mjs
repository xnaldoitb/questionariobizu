...
export const sessionCookie=token=>`quiz_session=${token}; Path=/; HttpOnly; ${process.env.VERCEL_ENV==='development' || process.env.NODE_ENV==='development'?'':'Secure; '}SameSite=Lax; Max-Age=43200`;
export const clearCookie=`quiz_session=; Path=/; HttpOnly; ${process.env.VERCEL_ENV==='development' || process.env.NODE_ENV==='development'?'':'Secure; '}SameSite=Lax; Max-Age=0`;
