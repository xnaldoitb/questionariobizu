...
import { hasPaidQuestionAccess } from '../platform/access-policy.mjs';
...
export const handler = async (event) => {
    ...
    if (hasPaidQuestionAccess(user)) {
        return json(409, { erro: 'Seu acesso Premium ou VIP já está ativo. Nenhuma nova cobrança foi criada.' });
    }
