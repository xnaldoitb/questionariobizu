-- Questionário Bizu - ADM Supremo e aprovação de cadastros
...
-- Garante que exista no máximo um ADM Supremo.
...
-- Depois desta migração, promova SUA conta principal para Supremo, por exemplo:
-- update public.usuarios
