...
if (!index.includes('manifest.webmanifest?v=4.52.6') || !serviceWorker.includes('questionario-bizu-v4.52.6')) {
    throw new Error('Versão e cache PWA v4.52.6 não estão sincronizados.');
}
...
console.log('Questionário Bizu v4.52.6: verificações estruturais concluídas.');
