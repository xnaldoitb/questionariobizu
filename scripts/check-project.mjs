...
if (!index.includes('manifest.webmanifest?v=4.50.3') || !serviceWorker.includes('questionario-bizu-v4.50.3')) {
    throw new Error('Versão e cache PWA v4.50.3 não estão sincronizados.');
}
...
console.log('Questionário Bizu v4.50.3: verificações estruturais concluídas.');
