...
if (!index.includes('manifest.webmanifest?v=4.52.3') || !serviceWorker.includes('questionario-bizu-v4.52.3')) {
    throw new Error('Versão e cache PWA v4.52.3 não estão sincronizados.');
}
...
console.log('Questionário Bizu v4.52.3: verificações estruturais concluídas.');
