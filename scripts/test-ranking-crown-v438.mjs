...
assert(performance.includes("<span class=\"podium-position\">${rankBadge(index)} ${index + 1}º</span>${patentButtonMarkup(entry.acertos, { developer: developerEntry(entry), admin: adminEntry(entry) })}"));
