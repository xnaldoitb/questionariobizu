...
assert(index.includes('15-progression-notifications.css') && index.includes('4.50.1'));
assert(worker.includes('questionario-bizu-v4.50.1') && worker.includes('15-progression-notifications.css'));
