...
assert(index.includes('15-progression-notifications.css') && index.includes('4.53.0'));
assert(worker.includes('questionario-bizu-v4.53.0') && worker.includes('15-progression-notifications.css'));
