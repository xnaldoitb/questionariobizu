...
assert(index.includes('15-progression-notifications.css') && index.includes('4.54.2'));
assert(worker.includes('questionario-bizu-v4.54.2') && worker.includes('15-progression-notifications.css'));
