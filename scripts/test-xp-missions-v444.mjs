...
assert(index.includes('15-progression-notifications.css') && index.includes('4.51.0'));
assert(worker.includes('questionario-bizu-v4.51.0') && worker.includes('15-progression-notifications.css'));
