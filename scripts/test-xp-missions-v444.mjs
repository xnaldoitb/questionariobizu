...
assert(index.includes('15-progression-notifications.css') && index.includes('4.52.6'));
assert(worker.includes('questionario-bizu-v4.52.6') && worker.includes('15-progression-notifications.css'));
