...
assert(index.includes('15-progression-notifications.css') && index.includes('4.54.1'));
assert(worker.includes('questionario-bizu-v4.54.1') && worker.includes('15-progression-notifications.css'));
