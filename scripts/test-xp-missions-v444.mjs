...
assert(index.includes('15-progression-notifications.css') && index.includes('4.49.0'));
assert(worker.includes('questionario-bizu-v4.49.0') && worker.includes('15-progression-notifications.css'));
