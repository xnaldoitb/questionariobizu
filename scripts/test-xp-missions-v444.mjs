...
assert(index.includes('15-progression-notifications.css') && index.includes('4.52.3'));
assert(worker.includes('questionario-bizu-v4.52.3') && worker.includes('15-progression-notifications.css'));
